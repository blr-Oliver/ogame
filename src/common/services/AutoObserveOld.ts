...
export interface ObserveSettingsOld {
  pause: boolean;
...
export const DEFAULT_OBSERVE_SETTINGS: ObserveSettingsOld = {
  pause: true,
...
export class AutoObserveOld {
  private observeNext: any | null = null;
  readonly settings: ObserveSettingsOld = {...DEFAULT_OBSERVE_SETTINGS};
